...
export function getExplorerLink(
  ...
  if (chainId === SupportedChainId.ZKSYNC_ERA) {
    switch (type) {
      case ExplorerDataType.TRANSACTION:
        return `https://explorer.zksync.io/tx/${data}`;
      case ExplorerDataType.ADDRESS:
      case ExplorerDataType.TOKEN:
        return `https://explorer.zksync.io/address/${data}`;
      case ExplorerDataType.BLOCK:
        return `https://explorer.zksync.io/block/${data}`;
      default:
