...
export type ChainInfo = { readonly [chainId: number]: L2ChainInfo } & {
  readonly [chainId in SupportedL1ChainId]: L2ChainInfo;
};
...
export const CHAIN_INFO: ChainInfo = {
  [SupportedChainId.ZKSYNC_ERA]: {
    ...
    statusPage: "",
    bridge: "",
    nativeCurrency: { name: "ZKSync", symbol: "ZKSync", decimals: 18 },
  },
  // [SupportedChainId.ROPSTEN]: {
  //   docs: "",
