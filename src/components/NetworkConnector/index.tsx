...
function NetworkIndicator() {
  ...
  useEffect(() => {
    if (!param && !chainId) {
      history.push(`${location.pathname}?chain=zksync_era`);
    }
    ...
    <>
      ...
      >
        <Flex alignItems="center">
          <Box mr={2}>
            <Img w="30px" src={"https://l2beat.com/icons/zksync-lite.png"} />
            {/* {info.label == "Binance" ? (
              <BinanceIcon />
            ) : // <EthereumIcon />
